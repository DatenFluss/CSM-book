package com.android.csm_book.presentation.content.discrete_math
...
@Composable
fun DiscreteMathStudyPage(navController: NavHostController) {
    val context = LocalContext.current
    val studyPageContent = remember { loadStudyPageContent(context, R.raw.discrete_math_page) }
    ...
    BaseStudyPage(
        ...
        visualizationRoute = "graphsVisualization",
        testRoute = "graphsTest"
    )
}
