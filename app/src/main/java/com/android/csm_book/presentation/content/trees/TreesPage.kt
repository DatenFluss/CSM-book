...
@Composable
fun TreesPage(navController: NavHostController) {
    val context = LocalContext.current
    val studyPageContent = remember { loadStudyPageContent(context, R.raw.trees_page) }
    ...
    BaseStudyPage(
        ...
        visualizationRoute = "treesVisualization",
        testRoute = "treesTest"
    )
}
